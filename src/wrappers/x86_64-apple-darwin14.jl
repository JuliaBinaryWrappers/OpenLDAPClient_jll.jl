# Autogenerated wrapper script for OpenLDAPClient_jll for x86_64-apple-darwin14
...
const liblber_splitpath = ["lib", "liblber.dylib"]
...
const libldap_splitpath = ["lib", "libldap.dylib"]
...
const libldap_r_splitpath = ["lib", "libldap_r.dylib"]
